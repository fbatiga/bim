...
class ContactList extends React.Component {
	...
	render() {
		...
		return (
			...
			<ScrollView horizontal={true} containerContentStyle={{}}
			>
			...
			pagingEnabled={true}
			viewSize={this.state.contacts._cachedRowCount}
			/>
			</View>
		);
	}
	...
	renderRecipientRow(rowData) {
       ...
       return ( <ContactItem onPress={this.props.callback} rowData={rowData} /> );
   }
}
